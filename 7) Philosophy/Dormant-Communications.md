...
<!--[Those downsides are true,] Unless that were the planned, controlled path [for specific people and prophets]. __.
...
> And need to point out how many interactions there are to account for, and why divided experiences are better than just a singular one, resulting in those many interaction problems—variety, without compromising truth and intelligence mainly
