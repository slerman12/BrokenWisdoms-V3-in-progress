...
Niaz's group also provided a GPU and I built [a general system to access it as well](https://github.com/AGI-init/Tributaries/tree/main), one her PhD student could use, [for him, largely](https://github.com/AGI-init/Tributaries/blob/main/Examples/Sweeps/XRDsPaperBluehive.py).

On the school's [supercomputers clusters](https://github.com/AGI-init/Tributaries/blob/main/Examples/Servers/Bluehive.py) (["Bluehive"](https://www.sas.rochester.edu/psc/assets/pdf/bluehivetutorial.pdf)) that require VPN access, [which I also automated](https://github.com/AGI-init/Tributaries/blob/main/VPN.py) for us.

This is no trivial thing. Bluehive is hard to use. The library is now a general-purpose SLURM launcher.

Building this took [time](https://github.com/slerman12/SweepsAndPlots).
