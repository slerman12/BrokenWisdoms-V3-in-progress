...
This is no trivial thing. Bluehive is hard to use. The [library](https://github.com/AGI-init/Tributaries/tree/main) had to generalize a lot to be a Bluehive SLURM launcher.
