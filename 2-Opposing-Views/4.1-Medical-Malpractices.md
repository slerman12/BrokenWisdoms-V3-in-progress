...
No, most likely it was an interaction between both, the Dupilumab cessation and whatever Kundalini processes were happening. I can probably tie this into the principles I was teaching Charles and team, that predictive factors of progression are unlikely to be individual saliences, but interactions (relations), hence my next paper, built from my considerations and research for the Med Center, ["Explaining Local, Global, And Higher-Order Interactions In Deep Learning,"](https://arxiv.org/abs/2006.08601) though I had initially planned a memory model for this purpose (and in retrospect, individual saliences rather than an interdependent analysis on the modeling side can possibly explain Parkinson's disease progression with sufficient control measures, especially pertaining to diet, my guess is, if study data included those control measures). My work and thoughts were ignored, and the universe gave me this paper, that in this way, among many others, is [woven with synchronicities](https://github.com/animal-tree/SuspiciousnessofSynchronicitiesAndParanoia/blob/main/Does-anyone-else-think-this-is-proof-of-God%3F.md) (that bring a horror-kind of narrative cohesion, but narrative cohesion nonetheless, to this described ["Crisis"](#crisis) chapter, narrative cohesion that despite the creepy-like nature of, evidences the physics reality of these synchronicities, including those in this book, being more than random coincidence or projected pattern), but isn't a paper I like or feel especially represents my research area interests, or writing style, and was written in the early recoveries of brain damage rather than [the relational reasoning paper I had finished running the final experiments for in this hospitalization](5-PhD-Faculty-Malpractices.md#mhdpa-summary), 2018, for which I didn't credit due to the ensuing aftermath, and has much more historical value.
