...
This wasn't obvious, having already been off the drug for months, and trusting my own body, as well as a pretty convincing I Ching answer, which, even in a skeptical context, may have been right.

Patients relying on medical advice from an ancient Taoist book, lacking any timely other with a doctor who takes months to get a scheduled appointment with for a patient already commited malpractice on, suggests the doctor might need an adaptivity plan in her scheduling prioritizing with her office, one that doesn't <!--require extreme arguing from--> a socially anxious patient (or require arguing), and which should absolutely be fast-tracked by a pharmaceutical deliverer, who were trying to call her also the first time.

`Neither the deliverer nor doctor warned if conducting a gradual tapering by going back on the drug was needed for a tapering process.`
...
See ["Second Induced Hair Loss"](6.2-Medical-Malpractices.md#second-induced-hair-loss) for how I lost my hair.
