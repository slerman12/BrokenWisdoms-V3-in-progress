...
Oh but for why they fell out, see ["Geriatric Unit Hospitalization"](6.2-Medical-Malpractices.md#geriatric-unit-hospitalization) and ["Second Induced Hair Loss,"](https://github.com/slerman12/BrokenWisdoms-V3-in-progress/blob/main/2-Opposing-Views/6.2-Medical-Malpractices.md#second-induced-hair-loss) which I perhaps should've called "Next University of Rochester Induced Hair Loss."
