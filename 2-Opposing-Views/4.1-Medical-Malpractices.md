...
> [!NOTE]
> Quick forewarning, and since the house on May St., I was [building a Keras-type framework](https://github.com/slerman12/ReinforcementLearningResearch/blob/master/Brains.py) (generalizing to Keras' functions, and not having heard of Keras) [for long-term memory](https://github.com/slerman12/ReinforcementLearningResearch) for the Medical Center, including the semester [I did my MHDPA innovation paper](https://github.com/slerman12/Research), that had generalized neural episodic control into a framework that I could use for disease prognostication, very novel, and which I’d also suggested could be used for interpreting exactly what measurements of a patient’s history informed the model’s predictions, similar to how attention weights <!--might-->more commonly do today. This amounted to nothing, but informed my future contemplations about long-term memory, and curiously forebodes what turned out to be the major project of the second half years of my PhD. 
...
No, most likely it was an interaction between both, the Dupilumab cessation and whatever Kundalini processes were happening (that, or a direct result of the meditation practices I was cultivating in the [House on May St.](1-Medical-Malpractices.md#house-on-may-st)). I can probably tie this into the principles I was teaching Charles and team, that predictive factors of progression are unlikely to be individual saliences, but interactions ("relational reasoning"), hence my next paper, built from my considerations and research for the Med Center, ["Explaining Local, Global, And Higher-Order Interactions In Deep Learning,"](https://arxiv.org/abs/2006.08601) though I had initially planned a memory model for this purpose (and in retrospect, individual saliences rather than an interdependent analysis on the modeling side can possibly explain Parkinson's disease progression with sufficient control measures, such as pertaining to diet, my guess is, if study data and procedures included those control measures). My work and thoughts were ignored by fate, and the universe gave me this paper, that in this way, among many others, is [woven with synchronicities](https://github.com/animal-tree/SuspiciousnessofSynchronicitiesAndParanoia/blob/main/Does-anyone-else-think-this-is-proof-of-God%3F.md) (that bring a horror-kind of narrative cohesion, but narrative cohesion nonetheless, to this described ["Crisis"](#crisis) chapter, narrative cohesion that despite the creepy-like nature of, evidences the physics reality of these synchronicities, including those in this book, being more than random coincidence or projected pattern), but isn't a paper I like or feel especially represents my research area interests, or writing style, and was written in the early recoveries of brain damage rather than [the relational reasoning paper I had finished running the final experiments for in this hospitalization](5-PhD-Faculty-Malpractices.md#mhdpa-summary)<!--in this hospital--> (["Distributional Relations In Deep Learning"](https://www.overleaf.com/read/qgmmzgsrctmg#6cd1b9)), 2018, for which I didn't get credit due to the ensuing <!--University of Rochester Strong Hospital -->aftermath, and (synchronicities aside) has much more historical value.

The Dupilumab cessation was spring, 2018, months preceding Christmas Eve/Day, 2018.
...
I also gave the "for pleasure" answer to the psychiatrist, who diagnosed me with bipolar manic episode and catatonia<!--, and presumably had access to the University of Rochester Strong Hospital's medical records, since the latter later --><!--had access to--><!--accessed the former's-->.
