...
That answer about whether my hair will grow back came true with the all-steak diet (steak is "manly" and so that again ties to the hexagram symbolism of "Fellowship with man," which I learned about with the recommendation [from Mikhaila Fuller](https://www.youtube.com/live/PF_7688Zk6s?si=puoPVQhB5osSow_6)), almost like a suggestion for how my hair can "sprout" out of the earth, my head, like blades of grass, again... which it did, temporarily but covering my entire head except for an unnoticeable tiny spot<!-- at the top of my scalp-->.

1. Then all the hair fell out again. Again, total baldness. No eyelashes, eyebrows, or hair.
2. Another time I did the all-steak diet, my pubic hair fully grew back—temporarily.
3. Another time I did the all-steak diet, a few eyelashes grew back for the first time. 

That can't be a coincidence, so I leave this story here both for medical utility and for the reminder that [I now look like Gollum](https://www.facebook.com/photo/?fbid=10211230008185126&set=a.1273659620707) because of medical malpractice, but furthernmore, to point out that my doctor didn't contact or warn me about the drug no longer being delivered again, once again not spotting the interruption of drug on which a patient is dependent, and warning the patient about the necessity of a gradual withdrawal process—if one such even existed at the time. For the second time, deliveries ceasing from the deliverer wasn't caught by the doctor in the management of drug prescriptions to patients. 

The deliverer called me before every delivery. When I stopped approving the delivery, they just accepted it, and nobody further pushed  or informed to maybe go through a withdrawal process, not before starting the drug or after, that gradually lowering the dose a bit at a time might've been necessary.

`The deliveries of the drug stopped again and neither the deliverer nor doctor bothered this time, no information/warning about withdrawing a bit at a time, gradually lowering the dose, provided.`

This was not obvious, having already been off the drug for months.

Admittedly, the look of someone relying on medical advice from an ancient Taoist book, lacking any timely other, combined with the alopecia universalis, makes me look rather like an obsessive maniac, if not physically literally like Gollum.

`I now look like Gollum`, and `other Gollum-esque symptoms` (see ["Fall, 2018 semester, and the Dead Marshes"](#fall-2018-semester-and-the-dead-marshes) and ["Nails"](6.1-Medical-Malpractices.md#nails)).
...
Perhaps this makes the hair loss look like my fault, and undermines the 3 self-induced regrowths and my knowledge about *psychiatric* med withdrawal, in particular the later experience where the University had no such consideration again, with benzos. Who knows about Dupilumab and what that antibody is? My other eczema meds I didn't have to withdraw. I didn't think to. I was already withdrawn for months!

Oh but for why the full head of hair of 1 fell out, *again*, in 2021, see ["Geriatric Unit Hospitalization"](6.2-Medical-Malpractices.md#geriatric-unit-hospitalization) and ["Second Induced Hair Loss,"](https://github.com/slerman12/BrokenWisdoms-V3-in-progress/blob/main/2-Opposing-Views/6.2-Medical-Malpractices.md#second-induced-hair-loss) which I perhaps should've called "Third University of Rochester Induced Hair Loss."

[This song just started playing on my Spotify](https://youtu.be/aOHmfq2AUaU?si=Lm4z1z4IqheQubbR), on random shuffle, by the way, though the entry point was [this](https://youtu.be/1XPlA6-dMGQ?si=wO9SWUqAPnTHVH7_), so take that steak with a grain of salt.
