...
But at this time, we were stopped on Clover St. A 4-leaf clobver represented "luck," sampled luck.
...
> There are multiple clover streets, I don't know if he still lives there, and the probability of a house from the union set of all of them is uniform
